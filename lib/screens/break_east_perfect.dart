...
class BreakEastPerfect extends StatelessWidget {
  const BreakEastPerfect({super.key});

  @override
  Widget build(BuildContext context) {
    return BuffetDetailsWidget(
      imagePath: BaseImages.buffetarabicperfect,
      onback: () {Get.off(BreakfastBuffetScreen());},
      title: Text(
        'فطور عربي فاخر',
        style: TextStyle(
