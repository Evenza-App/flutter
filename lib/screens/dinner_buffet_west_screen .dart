...
class DinnerBuffetWestScreen extends StatelessWidget {
  const DinnerBuffetWestScreen({super.key});
                        ...
                        child: Container(
                          ...
                          decoration: ShapeDecoration(
                            ...
                            shape: RoundedRectangleBorder(
                              side: BorderSide(
                                  width: 1.w, color: BaseColors.orange),
                      ...
                      child: Column(
                        children: [
                          Column(
                            children: [
                              TextButton(
                                onPressed: () => Get.off(DinnerWestMod()),
                                child: Container(
                                  width: 264.w,
                                  height: 248.h,
                                  child: Stack(
                              ...
                              Padding(
                                ...
                                child: TextButton(
                                  onPressed: () => Get.off(DinnerWestPerfect()),
                                  child: Container(
                                    width: 264.w,
                                    height: 248.h,
                                    child: Stack(
                              ...
                              Padding(
                                ...
                                child: TextButton(
                                  onPressed: () => Get.off(DinnerWestMix()),
                                  child: Container(
                                    width: 264.w,
                                    height: 248.h,
                                    child: Stack(
